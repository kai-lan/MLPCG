...
fluidnet_model_res_file = os.path.join(OUT_PATH, f"output_2D_{NN}", f"checkpt_dambreak_M{num_mat}_ritz{num_ritz}_rhs{num_rhs}_res_binary.tar")
...
plt.plot(res_fluidnet_res, label='fluidnet_res_binary')
